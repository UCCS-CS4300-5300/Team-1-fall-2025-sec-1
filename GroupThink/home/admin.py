"""Admin configuration for the GroupThink home application."""
...
class WorkspaceMembershipAdmin(admin.ModelAdmin):
    """Admin interface for WorkspaceMembership model."""
...
class TaskAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'title', 'workspace', 'assigned_to', 'status', 'is_personal', 'due_date', 'created_by'
    )
