...
def _get_meeting_participants(meeting: Meeting) -> list[dict]:
    ...
    """
    from .models import UserProfile  # pylint: disable=import-outside-toplevel
...
{TASK_SCHEMA}"""
    ...
    except (json.JSONDecodeError, KeyError, IndexError, Exception) as e:  # pylint: disable=broad-exception-caught
