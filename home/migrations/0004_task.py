...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0003_meeting_ended_at_meeting_recording_url_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workspace', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='home.workspace')),
            ],
            options={
                'ordering': ['-created_at'],
            },
