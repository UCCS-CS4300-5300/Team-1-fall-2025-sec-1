...
from .models import UserProfile, Workspace, WorkspaceMembership, Meeting, Task
...
class WorkspaceAdmin(admin.ModelAdmin):
    list_display = ('name', 'created_by', 'invite_code', 'code_visible_to_members', 'created_at')
...
class TaskAdmin(admin.ModelAdmin):
    list_display = ('title', 'workspace', 'assigned_to', 'status', 'is_personal', 'due_date', 'created_by')
